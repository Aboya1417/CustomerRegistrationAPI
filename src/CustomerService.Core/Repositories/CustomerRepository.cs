        ...
        public async Task<string> CustomerOnBoarding(CustomerDetailsVm entity)
        {
            ...
            try
            {
                if (entity.phoneNumber == null)
                    throw new Exception("Kindly Input Your Phone Number");
                if (entity.email == null)
                {
                    throw new Exception("Kindly Input Your Email Address");
                }
                if (entity.password == null)
                {
                    throw new Exception("Kindly Input Your Password");
                }
                ...
                //customer.StateId = newState.StateId;
                ...
                Headers =
    {
        ...
        { "X-RapidAPI-Key", "a98a2556a0msh8b0bd4267b4a0dep14147djsndc2a3e589831" },
            ...
            using (var response = await client.SendAsync(request))
            {
                ...
                var metals = JsonSerializer.Deserialize<MetalPriceVm>(body);
                return metals.gold;
            }
        }
    }
